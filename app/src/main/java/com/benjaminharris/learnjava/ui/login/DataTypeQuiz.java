...
public class DataTypeQuiz extends AppCompatActivity {
    ...
    public void initialize()
    {
        ...
        questions.add(new Questions("How many Primitive Data Types are there?", "6",
                "9", "8", "c"));
        questions.add(new Questions("\n " + "How long is the size of the 'int' data type?\n" ,
                "4 bytes", "2 bytes", "8 bytes", "a"));
        questions.add(new Questions("Which data types stores decimal values?",
                "short", "int", "double", "c"));
        questions.add(new Questions( "Which data type stores a single character?\n" ,
                "float", "char", "String", "b"));
        questions.add(new Questions("Non-Primitive data types..",
                "Refer to objects",
                "Always have a value ",
                "Cannot be used to call methods", "a"));
